...
def resource_path(relative_path):
    """
    Retourne le chemin absolu vers une ressource à partir du dossier racine du projet.
    Compatible PyInstaller et exécution normale.
    """
    import sys
...
class ImageViewer(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        # Charge la bibliothèque de distances au démarrage
        ...
        # Ajoute le widget pyqtgraph dans le layout du rightPanel
        ...
        # Ajoute le label de coordonnées sur le widget pyqtgraph
...
##################################################################################################################
    ...
    def apply_button_effects(self):
        ...
        # Détermine la couleur du shadow selon le thème
...
##################################################################################################################
    ...
    def closeEvent(self, event):
        try:
            ...
            # Utilise le dernier chemin de preset utilisé (chargé ou sauvegardé)
            preset_path = self.last_preset_path if hasattr(self, 'last_preset_path') and self.last_preset_path else self.get_preset_path()
...
def save_last_theme(theme_name):
    try:
        ...
        raise Exception(f"Error while saving theme: {e}")
...
def load_last_theme():
    try:
        ...
        raise Exception(f"Error while loading theme: {e}")
    return None
